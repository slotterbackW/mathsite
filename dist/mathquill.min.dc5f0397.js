...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/mathquill-0.10.1/mathquill.min.js":[function(require,module,exports) {
...
!function () {
  ...
  var m,
    ...
    this.byId = {}, t.init = function () {
      ...
      for (t = Dt(t || this.html()), n = 0; n < t.length; n += 1) {
        e(t[n]);
      }
  ...
  l.prototype = $t.p, l.interfaceVersion = function (t) {
    ...
    t.init = function (t) {
      ...
      if (0 !== p._maxLength) {
        ...
        for (s = this[Ct]; s instanceof I; s = s[Ct]) {
          e += s.letter;
        }
  ...
  tt ? Y = function Y(t, e, n) {
    t.css(tt, "scale(" + e + "," + n + ")");
  } : "filter" in V ? (X = function X(t) {
      ...
      for (e = Tt; e; e = e === Tt ? Ct : !1) {
        if (this[e] instanceof rt) {
          for (n = "sub"; n; n = "sub" === n ? "sup" : !1) {
            i = this[n], s = this[e][n], i && (s ? i.isEmpty() ? o = _t(s, 0, s.ends[Tt]) : (i.jQ.children().insAtDirEnd(-e, s.jQ), r = i.children().disown(), o = _t(s, r.ends[Ct], s.ends[Tt]), e === Tt ? r.adopt(s, s.ends[Ct], 0) : r.adopt(s, 0, s.ends[Tt])) : this[e].addBlock(i.disown()), this.placeCursor = function (t, n) {
              return function (i) {
                i.insAtDirEnd(-e, t || n);
              };
            }(s, i));
    ...
    e.createLeftOf = function (e) {
      if (!this.replacedFragment) {
        for (var i = e[Tt]; i && !(i instanceof Q || i instanceof (Et.text || t) || i instanceof ot || "\\ " === i.ctrlSeq || /^[,;:]$/.test(i.ctrlSeq));) {
          i = i[Tt];
        }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/mathquill-0.10.1/mathquill.min.js"], null)
//# sourceMappingURL=/mathquill.min.dc5f0397.js.map